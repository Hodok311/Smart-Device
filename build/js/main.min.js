...
require("./modules/show-more/init-show-more");
// ---------------------------------
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/phone-mask":13,"./modules/show-more/init-show-more":14,"./modules/smooth-scroll/init-smooth-scroll":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  var toggleText = function toggleText(button, textBlock, initialHeight, maxHeight) {
    ...
    if (isOpened) {
      ...
      textBlock.style.maxHeight = "".concat(190, "px");
      button.textContent = 'Подробнее';
    } else {
      textBlock.classList.add('active');
      textBlock.style.maxHeight = "".concat(510, "px");
